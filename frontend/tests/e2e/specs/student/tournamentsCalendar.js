describe('Tournaments Calendar Tests', () => {
  ...
  it('creates 2 tournaments and enrolls in them', () => {
    cy.createTournament('Demo-Tournament-PEPE', 7, 8, 20);
