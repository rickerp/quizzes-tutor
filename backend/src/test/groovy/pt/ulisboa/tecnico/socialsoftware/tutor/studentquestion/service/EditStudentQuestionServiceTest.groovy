...
@DataJpaTest
class EditStudentQuestionServiceTest extends Specification {
    ...
    def "edit question on a accepted student question"() {
        ...
        when:
        def result = studentQuestionService.editStudentQuestion(studentQuestionDto)
    ...
    def "edit question on a rejected student question"() {
        given: "a question"
        def question = new Question(course, questionDto)
        questionRepository.save(question)
        ...
        and: "an evaluation"
        def evaluation = new Evaluation()
        evaluation.setJustification("Please redo your question");
        ...
        when: "edit a rejected student question"
        studentQuestionService.editStudentQuestion(studentQuestionDto)
